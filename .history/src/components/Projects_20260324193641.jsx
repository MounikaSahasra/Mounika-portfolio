...
const PROJECTS = [
  {
    ...
    description: 'A full-stack project management tool built for developers. Features real-time collaboration, Kanban boards, sprint planning, and GitHub integration.',
