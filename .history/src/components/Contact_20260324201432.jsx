...
const CONTACT_LINKS = [
  { icon: '📧', label: 'Email', value: 'memounikababurajan@gmail.com', href: 'mailto:mounika@dev.com' },
  { icon: '💼', label: 'LinkedIn', value: 'linkedin.com/in/mounika', href: 'https://linkedin.com' },
  { icon: '⌨️', label: 'GitHub', value: 'github.com/mounika', href: 'https://github.com' },
