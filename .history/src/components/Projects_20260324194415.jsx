...
const PROJECTS = [
...

  {
    ...
    description: A web application to monitor daily tasks and productivity, featuring task management, progress tracking, and a clean, responsive interface for improved efficiency.Modern e-commerce platform with dynamic product filtering, cart management, payment gateway integration, and admin dashboard.',
