...
function DeveloperIllustration() {
  return (
    ...
    >
      ...
      <motion.div className="badge badge-3" animate={{ y: [0, -6, 0] }} transition={{ repeat: Infinity, duration: 3, delay: 1 }}>
        <span>🐍</span> Java
      </motion.div>
      <motion.div className="badge badge-4" animate={{ y: [0, -15, 0] }} transition={{ repeat: Infinity, duration: 2.8, delay: 0.5 }}>
        <span>🟨</span> JS
      </motion.div>
